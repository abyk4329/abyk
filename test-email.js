    ...
    <div class="container">
      <div class="content">
        ...
        <div style="text-align: center; padding: 25px; background: linear-gradient(135deg, #f6efe6 0%, #f0e7d8 100%); border-radius: 12px; margin: 30px 0; border: 1px solid #D4B896;">
          ...
          <a href="https://abyk.online/thank-you?bd=3&bm=7&by=9&lp=1" style="display: inline-block; background: linear-gradient(135deg, #C6A170 0%, #B8956A 100%); color: white; text-decoration: none; padding: 15px 30px; border-radius: 8px; font-weight: 600; font-size: 16px; margin: 10px 0; box-shadow: 0 4px 15px rgba(198, 161, 112, 0.3);">
            צפו בפירוש המלא
          </a>
        </div>

        <div style="text-align: center; margin: 30px 0;">
          <a href="https://abyk.online/thank-you?bd=3&bm=7&by=9&lp=1" class="cta-button">
      ...
      <div class="footer">
        <div style="margin-bottom: 20px;">
          <img src="https://abyk.online/newlogos/ikon.png" alt="Awakening by Ksenia" style="width: 80px; height: auto; margin-bottom: 15px;">
        </div>
