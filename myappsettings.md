...
### העיצוב: צבע שמפניה בהירה , אלגנטי, עם hover יפה

### זה הכפתור המרכזי בעמוד הפתיחה
...
## **ללא אימוג׳י , האתר חייב להראות אלגנטי ומינימליסטי**

## **הוספת עומק לאתר אפשר לשחק עם הדגשות של המילים והווי שונה בטקסטים בעמודים**
...
## לפיתוח בהמשך( כרגע לא רלוונטי)

### שמירת תוצאות חישוב לחשבון אישי | Save results to profile

### Dashboard אישי למשתמשים רשומים | User dashboard
