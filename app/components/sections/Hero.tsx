...
import { BRAND, PAYMENT } from "@/lib/constants";

export function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden py-20">
      <div className="absolute inset-0 -z-10 opacity-60">
        <div className="absolute -top-40 right-0 h-96 w-96 rounded-full bg-[#f5f1ed] blur-3xl" aria-hidden />
        <div className="absolute bottom-0 left-0 h-80 w-80 rounded-full bg-[#d3c6bd] blur-3xl" aria-hidden />
      </div>
