...
import { Interpretations } from "@/modules/wealth-code/components";
...
export function InterpretationsPageClient({ code }: InterpretationsPageClientProps) {
  ...
  return (
    <NavigationProvider value={navigationOverrides}>
      <Interpretations code={code} onCalculateAnother={handleCalculateAnother} />
    </NavigationProvider>
  );
}
