...
export const wealthCodeTexts: Record<number, DigitBlock> = {
  1: {
    digit: "1",
    title: "המנהיג/ה",
  ...
  2: {
    digit: "2",
    title: "הדובר/ת",
    essence: `ספרה 2 היא אנרגיה של תקשורת, יחסים והרמוניה. היא נועדה להביא גשר בין עולמות – בין אנשים, בין רעיונות ובין הלב למציאות. ה־״2״ יודע לנוע דרך המילה: דיבור, הקשבה, כתיבה או שירה.
במהותה הפנימית, הספרה 2 מסמלת קול פנימי שמבקש להישמע. היא נולדה להביא אמת אל השטח – לא בצעקה כוחנית, אלא בקול רך, ברור ומשפיע.`,
  ...
  3: {
    digit: "3",
    title: "היוצר/ת",
    essence: `ספרה 3 מייצגת יצירתיות, שמחת חיים וביטוי אישי. היא מביאה צבע, משחק ואנרגיה שמרימה את כל מי שסביבה. אנשים עם הספרה הזו נולדו כדי לבטא את עצמם – דרך אמנות, דיבור, תנועה, כתיבה או כל צורה אחרת של יצירה.
...
כש־״3״ לא יוצר או מבטא את עצמו – הוא מרגיש ריקנות, חוסר משמעות ולעיתים תסכול עמוק.`,
  ...
  4: {
    digit: "4",
    title: "הבונה/ת",
    essence: `ספרה 4 היא אנרגיה של יסוד, משמעת, התמדה ומבנה. היא מייצגת את הקרקע המוצקה שעליה אפשר להניח יסודות חזקים. מי שנושא את ה־״4״ נועד לקחת חלומות ולבנות מהם תשתית ממשית – מערכת שעובדת לאורך זמן.
ה־״4״ הוא לא ״חולם באוויר״, אלא אדריכל של מציאות: כזה שיודע להפוך רעיונות מופשטים למסלולים ברורים, לשגרה ולפעולות שניתן לסמוך עליהן.`,
  ...
  5: {
    digit: "5",
    title: "החוקר/ת",
    essence: `ספרה 5 מייצגת אנרגיה של ידע, חכמה וסקרנות מתמדת. היא נועדה לגלות, לחקור ולשאול שאלות שמעבר למה שנראה לעין. ה־״5״ הוא תלמיד נצחי שתמיד מחפש להבין לעומק, אך בו־בזמן הוא גם מורה טבעי, עם יכולת נדירה לפשט מורכבויות ולהעביר אותן בצורה בהירה לאחרים.
מי שנושא את אנרגיית ה־״5״ חי בעולם של רעיונות, למידה ותובנות. הוא אוהב להעמיק בספרים, קורסים ושיחות אינטלקטואליות, ובו זמנית נהנה לחלוק את הידע הזה עם אחרים.`,
    gifts: [
  ...
  6: {
    digit: "6",
    title: "האמן/ית",
    essence: `ספרה 6 היא אנרגיה של יופי, אהבה והרמוניה – פנימית וחיצונית. היא מביאה איתה רגישות אסתטית נדירה, נטייה לראות את העולם דרך יופי וצורה, וחיבור טבעי לאמנות, ליחסים ולבית.
ה־״6״ נולד להביא ריפוי דרך יופי, יצירה וזוגיות בריאה. יש בו יכולת לגעת בלב של אנשים דרך מראה, קול, תנועה או מגע – ולהפוך סביבה פשוטה למרחב נעים ומרפא.`,
    gifts: [
  ...
  7: {
    digit: "7",
    title: "הלוחם/ת",
    essence: `ספרה 7 מייצגת עומק, צדק, משמעת ועוצמה פנימית. היא אנרגיה של אדם שמוכן להילחם על האמת שלו, לא מתפשר בקלות, ומביא איתו יכולת עמידה יוצאת דופן. אנשים עם ספרה זו נולדו עם צורך פנימי להיות נאמנים לעקרונות שלהם, לחפש משמעות ולפעול מתוך תחושת שליחות.
ה־״7״ יודע לראות את התמונה הגדולה ולתכנן לטווח ארוך, אבל כשהוא לא באיזון הוא עלול להפוך לקשוח, כוחני או חסר סבלנות – מה שמרחיק אנשים ויוצר מאבקים מיותרים.`,
  ...
  8: {
    digit: "8",
    title: "הסוחר/ת",
    essence: `ספרה 8 מביאה אנרגיה של שפע, ערך והשפעה כלכלית. היא יודעת לזהות הזדמנויות, להבין איפה יש ערך ולבנות מערכות שמייצרות רווח לאורך זמן. אנשים עם ספרה זו נולדו עם חוש עסקי טבעי – יכולת לראות עסקאות, לחבר אנשים וליצור מנגנונים שמכניסים כסף.
כשה־״8״ באיזון, הוא מנהל משא ומתן בחכמה, משדר נדיבות ובונה מערכות שמפרות את כולם. כשהוא לא באיזון, הוא עלול ליפול לחוסר אמון, קמצנות או אובססיה לצדק, מה שחוסם את זרימת השפע.`,
  ...
  9: {
    digit: "9",
    title: "המרפא/ה",
    essence: `ספרה 9 מגלמת אנרגיה של ריפוי, חמלה וחכמה עתיקה. היא נושאת ראייה רחבה על החיים ויכולת נדירה להבין את הלב שמאחורי כל סיפור.
...
export const sectionTitles: Record<keyof DigitBlock, string> = {
  digit: "ספרה",
  title: "כותרת",
  essence: "מהות הספרה",
  gifts: "מתנות מרכזיות",
  challenges: "חסימות ואתגרים עיקריים",
  imbalanceSigns: "נורות אדומות – סימנים לחוסר איזון",
  growthAreas: "מוקדי צמיחה והתפתחות",
  careerPaths: "תחומים מתאימים לקריירה ולשליחות",
  dailyPractice: "דוגמה יומית לתרגול",
