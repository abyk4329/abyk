        ...
        <div className="flex flex-col items-center space-y-5">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-white font-normal hover:text-[#B8860B] transition-colors duration-200 text-sm tracking-wide bg-transparent border-none cursor-pointer pt-[0px] pr-[0px] pb-[-25px] pl-[0px] mt-[0px] mr-[0px] mb-[-8px] ml-[0px]"
            >
          ...
          <div className="flex items-center justify-center gap-6 mt-[0px] mr-[0px] mb-[2px] ml-[0px]">
            ...
            <a 
              ...
              className="flex items-center gap-2 rounded-full bg-white/10 hover:bg-white/20 text-white hover:text-[#B8860B] transition-all duration-300 backdrop-blur-sm border border-white/20 hover:border-white/30 hover:scale-105 p-[6px]"
            >
            ...
            <a 
              ...
              className="flex items-center gap-2 rounded-full bg-white/10 hover:bg-white/20 text-white hover:text-[#B8860B] transition-all duration-300 backdrop-blur-sm border border-white/20 hover:border-white/30 hover:scale-105 py-[8px] px-[6px] p-[6px]"
            >
