...
export function WealthCodeInterpretations({
  ...
  return (
  <div className="flex min-h-full flex-col p-4 sm:p-6 text-center" lang="he" dir="rtl">
          <div className="mx-auto max-w-4xl">
            {/* Title Section */}
            <div className="mb-10 space-y-4 text-center">
              <h1 className="text-4xl font-bold tracking-wide text-[#87674F] sm:text-5xl">
            ...
            <Tabs defaultValue="structure" className="w-full" dir="rtl">
                ...
                <Card className="brand-card p-6 sm:p-8" dir="rtl">
                  <div className="space-y-6">
                    ...
                    <div className="text-center">
                      <div className="brand-panel inline-flex items-center gap-2 px-5 py-3 text-[#87674F]">
                    ...
                    <div className="text-center text-[#87674F]">
                      <p className="whitespace-pre-line font-['Assistant'] text-base leading-relaxed text-[#87674F]/90">
                        {structure.paragraph}
                      </p>
                    </div>
                    ...
                    {codeStructure.repeatedDigits.length > 0 && (
                      <div>
                        <h3 className="mb-4 text-center font-['Assistant'] text-lg font-semibold tracking-wide text-[#87674F]">
                        ...
                        <div className="flex justify-center gap-4">
                          {codeStructure.repeatedDigits.map(({ digit, count }) => (
                            <div key={digit} className="text-center">
                              <div
                                className="mb-2 flex h-12 w-12 items-center justify-center rounded-full bg-white/50 font-['Assistant'] text-2xl font-bold text-[#87674F] shadow-[0_12px_30px_-18px_rgba(94,73,52,0.4)]"
                              >
                                {digit}
                              </div>
                              <span className="font-['Assistant'] text-sm text-[#87674F]/80">
                                מופיע {count} פעמים
                              </span>
                            </div>
                          ))}
              ...
              <TabsContent value="numbers" className="space-y-6 text-center">
                <Card className="brand-card p-6 sm:p-8 text-center" dir="rtl">
                  <Tabs defaultValue={primaryDigitTab} className="w-full text-center" dir="rtl">
                    <TabsList
                    ...
                    {uniqueDigits.map((digit) => {
                      ...
                      return (
                        <TabsContent key={digit} value={digit.toString()} className="space-y-6 text-center" dir="rtl">
                          <div className="space-y-3 text-center text-[#87674F]">
                          ...
                          <div className="space-y-4 text-[#87674F]/90">
                            {numberDesc.content.map((section, index) => (
                              <div key={index} className="brand-panel px-5 py-6 text-center sm:px-7 sm:py-7">
                                <h4 className="mb-3 text-lg font-semibold text-[#87674F]">
                                  {section.title}
                                </h4>
                                ...
                                {section.items && (
                                  <ul className="space-y-2 text-base leading-relaxed text-center">
                                    {section.items.map((item, itemIndex) => (
                                      <li key={itemIndex} className="flex items-center justify-center gap-2">
                                        <span className="text-[#87674F]/50">•</span>
                                        <span>{item}</span>
                                      </li>
                                    ))}
                                  </ul>
              ...
              <TabsContent value="daily" className="space-y-6" dir="rtl">
                <Card className="brand-card p-6 sm:p-8 text-center" dir="rtl">
                  <div className="space-y-6 text-[#87674F]">
                    <section className="brand-panel px-6 py-6 text-center sm:px-8 sm:py-8">
