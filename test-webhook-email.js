...
<head>
    ...
    <title>הפירוש האישי לקוד העושר שלך מוכן - Awakening by Ksenia</title>
    <style>
        ...
        .number-sequence {
            ...
            letter-spacing: 8px;
            padding: 20px;
            background: linear-gradient(135deg, #f6efe6 0%, #f0e7d8 100%);
            border-radius: 12px;
        ...
        .pdf-button {
            ...
            font-weight: 600;
            font-size: 16px;
            box-shadow: 0 4px 15px rgba(198, 161, 112, 0.3);
            transition: all 0.3s ease;
        }
        .pdf-button:hover {
            background: linear-gradient(135deg, #B8956A 0%, #A68659 100%);
            box-shadow: 0 6px 20px rgba(198, 161, 112, 0.4);
        }
        .footer {
            background: #1F2024;
            color: white;
        ...
        @media (max-width: 600px) {
            ...
            .number-sequence { font-size: 28px; letter-spacing: 4px; }
        }
    </style>
</head>
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="main-title">הקוד העושר האישי שלך הוא</div>
            ...
            <div class="pdf-section">
                ...
                <div class="pdf-text">
                    הפירוש המלא שלך כולל ניתוח עמוק של כל מספר, השפעתו על תחומי חיים שונים, והקשרים הייחודיים בין המספרים בקוד שלך. קבלי תובנות מעמיקות על האישיות שלך, כשרונותיך, אתגריך ומסלול החיים המיועד לך.
                </div>
                <a href="${interpretationUrl}" class="pdf-button">צפי בפירוש המלא</a>
            </div>
        </div>
