...
const INLINE_STYLES = {
    ...
    outerCell: "padding:0;",
    innerTable: "width:100%;max-width:600px;border-collapse:collapse;background-color:#f8f6f2;margin:0 auto;",
...
<body style="${INLINE_STYLES.body}">
    ${preheader ? `<div style="display:none;font-size:1px;color:#fefefe;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">${preheader}</div>` : ""}
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="${INLINE_STYLES.outerTable}">
            <tr>
                <td align="center" style="${INLINE_STYLES.outerCell}">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="${INLINE_STYLES.innerTable}">
                        <tr>
                        ...
                        <tr>
                            <td style="${INLINE_STYLES.mainContentCell}" align="center">
                                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                    <tr>
                                        <td style="${INLINE_STYLES.glassCard}" align="center">
                                            ${content}
                                            ${socialLinksHtml}
                                        </td>
                                    </tr>
