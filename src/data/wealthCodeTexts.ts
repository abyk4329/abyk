// Single source of truth for Wealth Code texts (digits 1–9)

export type WealthCodeSectionKey =
  | "essence"
  | "gifts"
  | "challenges"
  | "imbalanceSigns"
...
export interface WealthCodeText {
  digit: string;
  title: string;
  essence: string;
  gifts: string[];
...
export const sectionTitles: Record<WealthCodeSectionKey, string> = {
  essence: "מהות הספרה",
  gifts: "מתנות מרכזיות",
...
export const wealthCodeTexts: Record<number, WealthCodeText> = {
  1: {
    digit: "1",
    title: "המנהיג/ה",
    essence:
