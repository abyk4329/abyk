        ...
        <div className="flex items-center justify-center">
          ...
          {showBack && (
            <Link
              ...
              className="absolute left-4 sm:left-6 top-1/2 -translate-y-1/2 z-10 px-3 py-2 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-md text-[#473B31] hover:opacity-80 hover:scale-[1.02] transition"
            >
