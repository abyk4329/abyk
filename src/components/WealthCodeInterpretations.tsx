...
// Central content source for all digits
const digitMeanings = {
  1: {
    title: "1 – המנהיג/ה",
    essence:
      "אנרגיה של התחלה, יוזמה והובלה. זוהי נקודת הפתיחה, הצעד הראשון, היכולת לעמוד לבד גם כשאין שביל מסומן.",
    gifts: [
      "מנהיגות טבעית",
      "אומץ לפרוץ קדימה",
      "יכולת קבלת החלטות",
  ...
  2: {
    title: "2 – הדובר/ת",
    essence:
      "מהות הספרה\nספרה 2 היא אנרגיה של תקשורת, יחסים והרמוניה. היא נועדה להביא גשר בין עולמות – בין אנשים, בין רעיונות ובין הלב למציאות. ה־״2״ יודע לנוע דרך המילה: דיבור, הקשבה, כתיבה או שירה.\nבמהותה הפנימית, הספרה 2 מסמלת קול פנימי שמבקש להישמע. היא נולדה להביא אמת אל השטח – לא בצעקה כוחנית, אלא בקול רך, ברור ומשפיע.",
    gifts: [
