...
<body>
    ...
    <div class="section">
        ...
        <p>עוצמה מרוכזת, מתנה של כוח ממוקד לצד צורך באיזון.</p>
    </div>
    ` : codeStructure.hasRepeats ? `
    <div class="section">
        <h2>ספרות חוזרות בקוד</h2>
        <p>אנרגיות מועצמות שמחייבות תשומת לב ואיזון בין תחומי החיים.</p>
    </div>
    ` : codeStructure.allDifferent ? `
    <div class="section">
        <h2>קוד מגוון - כל הספרות שונות</h2>
        <p>מגוון עשיר של אנרגיות הדורש הרמוניה פנימית.</p>
    </div>
    ` : ''}
