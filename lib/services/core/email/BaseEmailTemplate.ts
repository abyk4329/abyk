...
const INLINE_STYLES = {
  ...
  outerTable: "width:100%;border-collapse:collapse;background-color:#f8f6f2;",
  outerCell: "padding:0;",
  innerTable:
    "width:100%;max-width:600px;border-collapse:collapse;background-color:#f8f6f2;margin:0 auto;",
  header:
    "background-color:#f8f6f2;padding:24px 20px;border:none;box-shadow:5px 5px 10px #d1cfcc,-5px -5px 10px #ffffff;",
  headerTitle:
    "font-family:'Assistant', Arial, sans-serif;font-size:20px;font-weight:700;letter-spacing:0.15em;color:#5e4934;margin-bottom:4px;text-transform:uppercase;text-align:center;text-shadow:1px 1px 2px rgba(255,255,255,0.9);",
  headerSubtitle:
    "font-family:'Assistant', Arial, sans-serif;font-size:11px;font-weight:500;letter-spacing:0.13em;color:#9f8572;text-transform:uppercase;text-align:center;",
  mainContentCell: "padding:32px 0 0 0;",
  glassCard:
    "background:#f8f6f2;border:none;border-radius:32px;padding:40px 24px;width:100%;box-sizing:border-box;box-shadow:15px 15px 30px #d1cfcc,-15px -15px 30px #ffffff;margin:0 auto;",
  shareSection:
    "margin-top:32px;padding-top:24px;border-top:1px solid rgba(209,207,204,0.5);",
  socialButton:
    "display:inline-flex;align-items:center;justify-content:center;width:52px;height:52px;border-radius:50%;background:#f8f6f2;border:none;text-decoration:none;box-shadow:8px 8px 16px #d1cfcc,-8px -8px 16px #ffffff;margin:0 8px 12px;",
  footer:
    "background-color:#f8f6f2;padding:32px 20px;border:none;box-shadow:0 -5px 10px #d1cfcc,0 5px 10px #ffffff;",
  footerText:
    "font-family:'Assistant', Arial, sans-serif;font-size:14px;font-weight:400;color:#87674F;line-height:1.6;margin-bottom:12px;text-align:center;",
  footerSecondaryText:
    "font-family:'Assistant', Arial, sans-serif;font-size:12px;font-weight:400;color:#9f8572;line-height:1.6;margin-top:16px;text-align:center;",
  footerLink:
    "color:#87674F;text-decoration:none;border-bottom:1px solid rgba(135,103,79,0.3);",
  copyright:
    "display:inline-block;background:#f8f6f2;box-shadow:inset 5px 5px 10px #d1cfcc,inset -5px -5px 10px #ffffff;padding:8px 24px;border-radius:24px;border:none;",
  copyrightText:
    "font-family:'Assistant', Arial, sans-serif;font-size:11px;font-weight:700;color:#5e4934;letter-spacing:0.15em;text-transform:uppercase;text-shadow:1px 1px 2px rgba(255,255,255,0.9);margin:0;",
};
