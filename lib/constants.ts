...
export const BRAND = {
  ...
  tagline: "NUMEROLOGY TOOLS FOR CLEAR DECISIONS",
...
export const SOCIAL = {
  whatsapp: {
    ...
    getUrl: (message?: string) =>
      `https://wa.me/${WHATSAPP_INTERNATIONAL_NUMBER}?text=${encodeURIComponent(
        message || SOCIAL.whatsapp.messageDefault
      )}`,
  },
  instagram: {
...
export const COLORS = {
  ...
  text: {
    primaryLight: "#5e4934",
    secondaryLight: "#473b31",
    tertiaryLight: "#9f8572",
    primaryDark: "#e8dfd5",
    secondaryDark: "#c4b8a8",
  },
  accent: {
    light: "#c9a882",
    lightBright: "#dbb896",
...
/**
 * Icon stroke widths (Lucide / svg icons) to keep weight consistent בכל האפליקציה.
 */
export const ICON_STROKE = {
  default: 1,
  decorative: 0.5, // אייקון דקורטיבי בכרטיס הראשי מעל הכותרת
} as const;
 ...
 */
export const API = {
  sendEmail: routes.api.sendEmail,
  generatePDF: routes.api.generatePdf,
...
export const PWA = {
  ...
  icons: {
    favicon: "/ABYKICON.png",
    apple: "/ABYKICON.png",
    manifest192: "/ABYKICON.png",
    manifest512: "/ABYKICON.png",
  },
} as const;
 ...
 */
export const WEALTH_BASE = "" as const; // אפשר לשנות ל-"/wealth-code"
