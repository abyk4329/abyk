  ...
  const getFullWealthCodeData = (code: number) => {
    const dataMap: { [key: number]: any } = {
      ...
      4: {
        ...
        dailyPractice:
          "בחר/י משימה פיזית מוחשית אחת – לסדר, לארגן או לבנות משהו קטן. התחושה המוחשית של סגירת לופ תدلיקTRGLך אנרגיה מחודשת לעוד צעדים.",
        bottomLine:
      ...
      {showSalesPage && result ? (
        ...
        <div className="min-h-screen relative" lang="he">
          ...
          <div className="relative z-10 min-h-screen flex flex-col">
            ...
            {/* Main Content */}
            <main className="flex-1 px-4 sm:px-6 sm:py-8 px-[16px] py-[0px] py-[43px]">
