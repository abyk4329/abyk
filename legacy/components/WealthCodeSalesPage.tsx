                      ...
                      <form onSubmit={handleEmailFormSubmit}>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-6">
                          ...
                          <Button
                            size="lg"
                            variant="outline"
                            className="bg-amber-500/20 hover:bg-amber-500/30 text-amber-100 font-normal border border-amber-400/50 backdrop-blur-sm transition-all duration-300 shadow-lg hover:shadow-xl text-lg py-4 px-8 font-['Assistant'] tracking-wide"
                            onClick={() => {
                              console.log(
                                "🧪 Test button clicked!",
                              );
                              ...
                              if (onShowThankYou) {
                                ...
                                console.log(
                                  "❌ onShowThankYou is not available",
                                );
                                alert(
                                  "שגיאה: פונקציית המעבר לא זמינה. נסה לרענן את הדף.",
                                );
                              }
                            }}
                          >
