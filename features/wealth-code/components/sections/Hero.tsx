      ...
      <div className={["relative z-10 w-full", styles.contentLayer].join(" ")}>
        <CardStack className={styles.cardStack}>
          <div className={["relative", styles.cardFrame].join(" ")}>
            <div
              className={[
                "pointer-events-none absolute inset-x-4 -bottom-12 h-24 sm:inset-x-12 sm:-bottom-14 sm:h-28 lg:inset-x-16 lg:-bottom-16 lg:h-32",
                styles.shadow,
              ].join(" ")}
              aria-hidden="true"
            />
            ...
            >
              <div
                className="absolute inset-x-10 top-10 hidden sm:block opacity-60 blur-2xl"
                aria-hidden="true"
              >
