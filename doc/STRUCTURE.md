...
| **Selected Date**    | ערך דינמי לדוגמה: "13 בנובמבר 2025"                                                                         | צבע: `rgb(var(--color-support))` |
...
## 🔐 טופס התחברות | LoginForm.tsx

### טקסטים מדויקים

| אלמנט           | טקסט                  | הערות                   |
| --------------- | --------------------- | ----------------------- |
| **כותרת**       | "התחברות לאזור האישי" | `Title`, יישור למרכז    |
| **כפתור פעולה** | "כניסה"               | מצב טעינה: "מתחברים..." |

## ✍️ טופס הרשמה | SignupForm.tsx

### טקסטים מדויקים

| אלמנט           | טקסט                | הערות                        |
| --------------- | ------------------- | ---------------------------- |
| **כותרת**       | "הרשמה לאזור האישי" | `Title`, יישור למרכז         |
| **כפתור פעולה** | "הרשמה"             | מצב טעינה: "מתבצעת הרשמה..." |
...
| **קשר**               | "יצירת קשר"                                        |                            |
| **כניסה לאיזור אישי** | "כניסה לאיזור אישי"                                |                            |
| **משפטי**             | "תנאים משפטיים"                                    |                            |
| **PWA**               | "שמירה למסך הבית"                                  |                            |
